...
class SpecialistDashboardPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SpecialistDashboardPage> createState() => _SpecialistDashboardPageState();
}

class _SpecialistDashboardPageState extends ConsumerState<SpecialistDashboardPage> {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(state.errorMessage ?? 'Có lỗi xảy ra', style: const TextStyle(color: Colors.red)),
                      const SizedBox(height: 16),
                      ElevatedButton(
                        onPressed: () {
                          if (authState.user?.uid != null) {

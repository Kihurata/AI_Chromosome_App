    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 3 Main Nav Items
          _buildNavItem(icon: LucideIcons.layoutDashboard, title: 'Tổng quan', index: 0),
          _buildNavItem(icon: LucideIcons.users, title: 'Bệnh nhân', index: 1),
          _buildNavItem(icon: LucideIcons.calendarDays, title: 'Lịch khám', index: 2),
